...
<head>
    ...
    <title>Barza Awareness Campaign</title>
    <style>
        body {
        ...
        h1, h2 {
            color: #cd7f32; /* Bronze color for headers */
        }
        .content {
            background-color: #333333; /* Dark grey background for content */
            border-radius: 10px;
            box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3);
            padding: 20px;
        }
        a {
            color: #cd7f32; /* Bronze links */
        }
        .video-container {
            text-align: center;
        }
        ...
        button:hover {
            background-color: #a15a2f; /* Darker bronze on hover */
        }
    </style>
</head>
<body>
